...
export function CustomSignupForm({ onModeSwitch }: CustomSignupFormProps = {}) {
        ...
        <CardContent>
          ...
          <div className="mt-4 text-center text-sm">
            ...
            {onModeSwitch ? (
              ...
              <Link href="/signin" className="underline underline-offset-4 hover:text-primary transition-colors font-semibold">
                Sign in
              </Link>
            )}
          </div>
